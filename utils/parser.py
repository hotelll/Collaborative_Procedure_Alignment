...
def get_args():
    ...
    parser.add_argument('--archs', type = str, choices=['TSA'],default='TSA', help = 'our approach')
    ...
    parser.add_argument('--ckpts', type=str, default='/home/nzl/FineDiving_c/FineDiving_training_data/experiments/TSA/default/best2.pth', help='test used ckpt path')
    parser.add_argument('--save_path', type = str, default='FineDiving_training_data/experiments', help = 'path to save training results')
...
def setup(args):
    ...
    args.experiment_path = os.path.join(args.save_path, args.archs, args.prefix)
    if args.resume:
