...
class CPA_sampleStep(nn.Module):
    def __init__(self,
                 num_class=20,
                 num_clip=16,
                 dim_size=2048,
        ...
        super(CPA_sampleStep, self).__init__()
    ...
    def forward(self, x1, x2, embed=False):
        ...
        for batch in range(B):
            ...
            while k > 0:
                ...
                # -----------------------------------------------------------------------------
                step_feature1 = seq_features1[batch][video1_start]
                step_feature2 = seq_features2[batch][video2_start]
